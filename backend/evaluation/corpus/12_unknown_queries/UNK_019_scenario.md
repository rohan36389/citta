...
difficulty: medium
scenario_name: Unknown_Queries Scenario 19
expected_outcomes:
  initial_entity: NONE
...
turns:
  - turn: 1
    user: "Do you provide Quantum Solution 19?"
    expected_state:
      active_entity: NONE
    expected_response:
      must_include: ["couldn't find", "Contact page"]
      must_not_include: ["Quantum Solution 19"]
---

Customer:
Do you provide Quantum Solution 19?
