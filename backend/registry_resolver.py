...
def resolve_registry(
    ...
    If no entity is resolved, scans registry-level aliases (e.g. 'office' -> LOCATION).
    Never guesses.
    """
    # 1. Inherit directly from resolved entity
    ...
    # 2. Fallback to direct registry alias matching
